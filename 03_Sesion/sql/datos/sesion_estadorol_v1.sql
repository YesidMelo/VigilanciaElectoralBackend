...
SET @table_exists = (
  ...
  WHERE TABLE_SCHEMA = 'VigilanciaElectoral'
    AND TABLE_NAME = 'sesion_EstadoRolSistema'
);

truncate table VigilanciaElectoral.sesion_EstadoRolSistema;

-- Ejecutar DELETE solo si la tabla existe
SET @sql = IF(@table_exists > 0,
    'DELETE FROM VigilanciaElectoral.sesion_EstadoRolSistema;',
...
INSERT INTO VigilanciaElectoral.sesion_EstadoRolSistema (nombre, descripcion)
VALUES
