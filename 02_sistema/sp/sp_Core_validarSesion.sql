...
CALL Core_validarSesion(@login, @contrasenia, @codigoSalida);
select @codigoSalida;
*/
drop procedure if exists Core_validarSesion;

create procedure Core_validarSesion(
...
begin
   ...
   from 
      ...
      core_duracionsesionusuario dsu
   where
         login             = i_login
