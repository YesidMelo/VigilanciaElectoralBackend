...
select @codigoSalida;
*/
drop procedure if exists Core_registrarFuncion;

create procedure Core_registrarFuncion(
...
begin
   ...
   call Core_validarSesion(i_login, w_codigoValidacion);
   ...
   if w_codigoValidacion = '3' then
      insert into core_funcionrolsistema (nombre, descripcion) values (i_nombreFuncion, i_descripcionFuncion);
